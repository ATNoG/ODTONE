...
namespace odtone { namespace mihf {
    ...
    protected:
      ...
      static transaction_ack_service *ptr_instance;

    public:

      static transaction_ack_service *instance();
      ~transaction_ack_service();

      // template <class TransactionPtr>
      // void operator()(TransactionPtr t)
      // {
      ...
      void ack_responder(TransactionPtr t)
      {
        switch(t->ack_rsp_state)
          {
          case ACK_RSP_INIT: goto _rsp_init_lbl_;
          case ACK_RSP_RETURN_ACK: goto _rsp_return_ack_lbl_;
          case ACK_RSP_PIGGYBACKING: goto _rsp_piggybacking_lbl_;
          case ACK_RSP_RETURN_DUPLICATE: goto _rsp_return_duplicate_lbl_;
          }
...
#define tas transaction_ack_service::instance()
