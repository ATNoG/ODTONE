//==============================================================================
// Brief   : Timeout local message exchange unit test
 ...
 * timeout_unit_test: has received a "MIH_Capability_Discover.request"
 * timeout_unit_test: Send MIH_Capability_Discover.request
 * timeout_unit_test: has received a "MIH_Capability_Discover.confirm"
 * timeout_unit_test: Send MIH_Event_Subscribe.request
 * timeout_unit_test: has received a "MIH_Event_Subscribe.request"
 * timeout_unit_test: has received a "MIH_Event_Subscribe.confirm"
 * timeout_unit_test: Send MIH_Link_Up.indication
 * timeout_unit_test: Send MIH_Link_Down.indication
 * timeout_unit_test: Send MIH_Event_Unsubscribe.request
 * failure_unit_test: has received a "MIH_Event_Unsubscribe.request"
 * timeout_unit_test: has received a "MIH_Event_Unsubscribe.confirm"
 * timeout_unit_test: Send MIH_Link_Up.indication
 * timeout_unit_test: Send MIH_Link_Down.indication
 * timeout_unit_test: Send MIH_Link_Get_Parameters.request
 * timeout_unit_test: has received a "MIH_Link_Get_Parameters.request"
 * timeout_unit_test: has received a "MIH_Link_Get_Parameters.confirm"
 * timeout_unit_test: Send MIH_Link_Actions.request
 * timeout_unit_test: has received a "MIH_Link_Actions.request"
 * timeout_unit_test: has received a "MIH_Link_Actions.confirm"
 * timeout_unit_test: Send MIH_Link_Actions.request with PoA
 * timeout_unit_test: has received a "MIH_Link_Actions.request"
 * timeout_unit_test: has received a "MIH_Link_Actions.confirm"
 * timeout_unit_test: Send MIH_Link_Configure_Thresholds.request
 * timeout_unit_test: has received a "MIH_Link_Configure_Thresholds.request"
 * timeout_unit_test: has received a "MIH_Link_Configure_Thresholds.confirm"
 */
...
odtone::logger log_("timeout_unit_test", std::cout);
