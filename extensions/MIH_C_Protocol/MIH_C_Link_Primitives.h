...
typedef struct{
	 char Get_Param_Req[GET_PARAM_REQ];
}__attribute__((__packed__))MIH_C_Get_Param_Req;

//to delete
typedef struct{
	 char Link_ID_Char[MIHF_MAX_LINK_ID_NAME];
}__attribute__((__packed__))MIH_C_Link_ID_Name;
...
typedef struct{
	MIH_C_Type Type;
	MIH_C_Length Length;
	MIH_C_Link_ID_Name Link_ID_Name;
}__attribute__((__packed__))MIH_C_Mihf_ID_Rec;
...
// TLV 104 - LinkStatesRequest (Link Get Parameters Request)
typedef struct {
    MIH_C_Type Type;
    MIH_C_Length Length;
...
// TLV 106 - LinkDescriptorsRequest (Link Get Parameters Request)
typedef struct {
    MIH_C_Type Type;                     
    MIH_C_Length Length;                
...
typedef struct MIH_C_Capability_Discover_Conf{
      ...
      MIH_C_Mihf_ID_Mihf MIHF_Destination;
      MIH_C_Status Status;
      MIH_C_MIH_Evt_List MIH_Evt_List; // (optional - only if Status = Success)
      MIH_C_MIH_Cmd_List MIH_Cmd_List; // (optional - only if Status = Success)
...
typedef struct MIH_C_Event_Subscribe_Req{
      MIH_C_Header Header;
      MIH_C_Mihf_ID_User MIHF_Source;
      MIH_C_Mihf_ID_Link MIHF_Destination;
      MIH_C_MIH_Evt_List MIH_Evt_List;
...
typedef struct MIH_C_Event_Unsubscribe_Req{
      ...
      MIH_C_Mihf_ID_Mihf MIHF_Source;
      MIH_C_Mihf_ID_Link MIHF_Destination;
      MIH_C_Link_Tuple_Id_3GPP Link_Identifier;
      MIH_C_MIH_Evt_List MIHF_Requested_MIH_Evt_List;
      MIH_C_MIH_Evt_List Requested_MIH_Evt_List;
...
typedef struct MIH_C_Event_Unsubscribe_Conf{
      ...
      MIH_C_Mihf_ID_Mihf MIHF_Destination;
      MIH_C_Status Status;
      MIH_C_MIH_Evt_List Responce_MIH_Evt_List; // not included if Status = 0 (not successful)
...
typedef struct MIH_C_Get_Parameters_Req{
      ...
      MIH_C_Mihf_ID_Mihf MIHF_Source;
      MIH_C_Mihf_ID_Link MIHF_Destination;
      MIH_C_Get_Param_Req Get_Param_Req;
...
typedef struct MIH_C_Link_Configure_Thresholds_Req{
	...
	MIH_C_Mihf_ID_Mihf MIHF_Source;
	MIH_C_Mihf_ID_Link MIHF_Destination;
   	MIH_C_Link_Tuple_Id_3GPP Link_Tuple_Id;
...
typedef struct MIH_C_Link_Action_Request{
    ...
    MIH_C_Mihf_ID_Mihf MIHF_Source;
    MIH_C_Mihf_ID_Link MIHF_Destination;
    MIH_C_Link_Action_Req_List Link_Action_Req_List;
...
typedef struct MIH_C_Link_Detected_Indication{
    ...
    MIH_C_Mihf_ID_Link MIHF_Source;
    MIH_C_Mihf_ID_Mihf MIHF_Destination;
    MIH_C_Link_Det_Info_List Link_Det_Info_List;
