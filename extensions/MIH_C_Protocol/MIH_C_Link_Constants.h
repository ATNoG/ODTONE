...
#define MIH_LINK_HEADER_4_Cap_Disc_Req 0		// 00 00
#define MIH_LINK_HEADER_5_Cap_Disc_Req 4096 	// 00 10 (16)

// Capability discover confirm

#define MIH_LINK_HEADER_3_Cap_Disc_Conf 272		// 10 01 (1 0 1)
#define MIH_LINK_HEADER_4_Cap_Disc_Conf 0		// 00 00

// Event subscribe request

#define MIH_LINK_HEADER_3_Evt_Sub_Req 1044		// 14 04 (1 1 4)
#define MIH_LINK_HEADER_4_Evt_Sub_Req 0			// 00 00
#define MIH_LINK_HEADER_5_Evt_Sub_Req 5376 		// 00 15 (21)

// Event subscribe confirm

#define MIH_LINK_HEADER_3_Evt_Sub_Conf 1040	 	// 10 04 (1 0 4)
#define MIH_LINK_HEADER_4_Evt_Sub_Conf 0	 	// 00 00

// Event unsubscribe request

#define MIH_LINK_HEADER_3_Evt_Unsub_Req 1300    // 14 05 (1 1 5)
#define MIH_LINK_HEADER_4_Evt_Unsub_Req 0	    // 00 00
#define MIH_LINK_HEADER_5_Evt_Unsub_Req 5632 	// 00 16 (22)

// Event unsubscribe confirm

#define MIH_LINK_HEADER_3_Evt_Unsub_Conf 1296	// 10 05 (1 0 5)
#define MIH_LINK_HEADER_4_Evt_Unsub_Conf 0	    // 00 00
//#define MIH_LINK_HEADER_5_Evt_Unsub_Conf 6400 	// 00 19 (25)

// Link Get Parameters Request

#define MIH_LINK_HEADER_3_Get_Param_Req 308		// 34 01 (3 1 1)
#define MIH_LINK_HEADER_4_Get_Param_Req 0		// 00 00
#define MIH_LINK_HEADER_5_Get_Param_Req 13824	// 00 36 (54)

// Link Get Parameters Confirm

#define MIH_LINK_HEADER_3_Get_Param_Conf 304	// 30 01 (3 0 1)
#define MIH_LINK_HEADER_4_Get_Param_Conf 0		// 00 00

// Link Configure Threshold Request

#define MIH_LINK_HEADER_3_Link_Conf_Thres_Req 564	// 34 02 (3 1 2)
#define MIH_LINK_HEADER_4_Link_Conf_Thres_Req 0		// 00 00
#define MIH_LINK_HEADER_5_Link_Conf_Thres_Req 11264	// 00 2C (44) 

// Link Configure Threshold Confirm

#define MIH_LINK_HEADER_3_Link_Conf_Thres_Conf 560 	// 30 02 (3 0 2) 
#define MIH_LINK_HEADER_4_Link_Conf_Thres_Conf 0	// 00 00

// Link Action Request

#define MIH_LINK_HEADER_3_Link_Act_Req 820		// 34 03 (3 1 3) 
#define MIH_LINK_HEADER_4_Link_Act_Req 0		// 00 00
#define MIH_LINK_HEADER_5_Link_Act_Req 5376		// 00 15 (21)

// Link Action Confirm

#define MIH_LINK_HEADER_3_Link_Act_Conf 816		// 30 03 (3 0 3) 
#define MIH_LINK_HEADER_4_Link_Act_Conf 0		// 00 00
...
#define MIHF_MAX_LINK_ID_NAME_MIHF 6
#define MIHF_MAX_LINK_ID_NAME_LINK 5
#define MIHF_MAX_LINK_ID_NAME_USER 5
...
#define AID_LINK_REGISTER_INDICATION 6
...
// ODTONE SPECIFIC
#define TLV_LINK_REGISTER_TYPE 101
#define TLV_LIST_LINK_PARAM_TYPE 102
#define TLV_LINK_PARAMETERS_STATUS_LIST 103
#define TLV_LINK_STATES_RSP 105
#define TLV_LINK_DESCRIPTOR_RSP 107
#define TLV_LINK_ACTION 109
#define TLV_LINK_SCAN_RSP_LIST 110

// ODTONE Request
#define GET_PARAM_REQ 27
