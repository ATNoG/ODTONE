//==============================================================================
// Brief   : MIH_Link_Configure_Thresholds Request Message
...
public class MihLinkConfigureThresholdsRequest extends Message implements
		Serializeable {

	public MihLinkConfigureThresholdsRequest() {
		super();
		mid = MIH_Link_Configure_Thresholds_request;
		tlvList.add(new TlvInfo(new LinkIdentifierTlv(), false));
		tlvList.add(new TlvInfo(new ConfigureRequestListTlv(), false));
	}

	public MihLinkConfigureThresholdsRequest(int version, boolean ack_req,
			boolean ack_rsp, boolean uir, boolean m, int fn, boolean rsvd1,
			int rsvd2, int tid) {
		super(version, ack_req, ack_rsp, uir, m, fn, rsvd1,
				MIH_Link_Configure_Thresholds_request, rsvd2, tid);
		tlvList.add(new TlvInfo(new LinkIdentifierTlv(), false));
		tlvList.add(new TlvInfo(new ConfigureRequestListTlv(), false));
	}
