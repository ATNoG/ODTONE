//==============================================================================
// Brief   : MIH_MN_HO_Complete Indication Message
...
public class MihMnHoCompleteIndication extends Message implements
		Serializeable {

	public MihMnHoCompleteIndication() {
		super();
		mid = MIH_MN_HO_Complete_indication;
	...
	public MihMnHoCompleteIndication(int version, boolean ack_req,
			boolean ack_rsp, boolean uir, boolean m, int fn, boolean rsvd1,
			int rsvd2, int tid) {
		super(version, ack_req, ack_rsp, uir, m, fn, rsvd1,
				MIH_MN_HO_Complete_indication, rsvd2, tid);
		tlvList.add(new TlvInfo(new LinkIdentifierTlv(), false));
		tlvList.add(new TlvInfo(new NewLinkIdentifierTlv(), false));
		tlvList.add(new TlvInfo(new HandoverResultTlv(), false));
	}
