//==============================================================================
// Brief   : MIH_Link_Get_Parameters Response Message
...
public class MihLinkGetParametersResponse extends Message implements
		Serializeable {

	public MihLinkGetParametersResponse() {
		super();
		mid = MIH_Link_Get_Parameters_response;
	...
	public MihLinkGetParametersResponse(int version, boolean ack_req,
			boolean ack_rsp, boolean uir, boolean m, int fn, boolean rsvd1,
			int rsvd2, int tid) {
		super(version, ack_req, ack_rsp, uir, m, fn, rsvd1,
				MIH_Link_Get_Parameters_response, rsvd2, tid);
		tlvList.add(new TlvInfo(new StatusTlv(), false));
		tlvList.add(new TlvInfo(new DeviceStatesResponseListTlv(), true));
		tlvList.add(new TlvInfo(new GetStatusResponseListTlv(), true));
	}
