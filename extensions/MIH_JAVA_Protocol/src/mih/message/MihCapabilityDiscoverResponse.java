//==============================================================================
// Brief   : MIH_Capablity_Discover Response Message
...
public class MihCapabilityDiscoverResponse extends Message implements
		Serializeable {

	public MihCapabilityDiscoverResponse() {
		super();
		mid = MIH_Capability_Discover_response;
	...
	public MihCapabilityDiscoverResponse(int version, boolean ack_req,
			boolean ack_rsp, boolean uir, boolean m, int fn, boolean rsvd1,
			int rsvd2, int tid) {
		super(version, ack_req, ack_rsp, uir, m, fn, rsvd1,
				MIH_Capability_Discover_response, rsvd2, tid);
		tlvList.add(new TlvInfo(new StatusTlv(), false));
		tlvList.add(new TlvInfo(new LinkAddressListTlv(), true));
		tlvList.add(new TlvInfo(new MihEventListTlv(), true));
		tlvList.add(new TlvInfo(new MihCommandListTlv(), true));
	...
	public List<NetTypeAddr> getLinkAddressListTlv() {
		return ((LinkAddressListTlv) tlvList.get(1).getTlv()).getValue();
	}

	public void setLinkAddressListTlv(List<NetTypeAddr> value) {
		((LinkAddressListTlv) tlvList.get(1).getTlv()).setValue(value);
	}
	...
	public MihCmdList getMihCommandListTlv() {
		return ((MihCommandListTlv) tlvList.get(3).getTlv()).getValue();
	}

	public void setMihCommandListTlv(MihCmdList value) {
		((MihCommandListTlv) tlvList.get(3).getTlv()).setValue(value);
	}
	...
	public MihIqTypeLst getMiisQueryTypeListTlv() {
		return ((MiisQueryTypeListTlv) tlvList.get(4).getTlv()).getValue();
	}

	public void setMiisQueryTypeListTlv(MihIqTypeLst value) {
		((MiisQueryTypeListTlv) tlvList.get(4).getTlv()).setValue(value);
	}
	...
	public MihTransLst getTransportOptionListTlv() {
		return ((TransportOptionListTlv) tlvList.get(5).getTlv()).getValue();
	}

	public void setTransportOptionListTlv(MihTransLst value) {
		((TransportOptionListTlv) tlvList.get(5).getTlv()).setValue(value);
	}
	...
	public List<MbbHoSupp> getMbbHandoverSupportTlv() {
		return ((MbbHandoverSupportTlv) tlvList.get(6).getTlv()).getValue();
	}

	public void setMbbHandoverSupportTlv(List<MbbHoSupp> value) {
		((MbbHandoverSupportTlv) tlvList.get(6).getTlv()).setValue(value);
	}
}
