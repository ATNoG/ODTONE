//==============================================================================
// Brief   : MIH_Event_Unsubscribe Request Message
...
public class MihEventUnsubscribeRequest extends Message implements
		Serializeable {

	public MihEventUnsubscribeRequest() {
		super();
		mid = MIH_Event_Unsubscribe_request;
		tlvList.add(new TlvInfo(new LinkIdentifierTlv(), false));
		tlvList.add(new TlvInfo(new MihEventListTlv(), false));
	}

	public MihEventUnsubscribeRequest(int version, boolean ack_req,
			boolean ack_rsp, boolean uir, boolean m, int fn, boolean rsvd1,
			int rsvd2, int tid) {
		super(version, ack_req, ack_rsp, uir, m, fn, rsvd1,
				MIH_Event_Unsubscribe_request, rsvd2, tid);
		tlvList.add(new TlvInfo(new LinkIdentifierTlv(), false));
		tlvList.add(new TlvInfo(new MihEventListTlv(), false));
	}
