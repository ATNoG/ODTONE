//==============================================================================
// Brief   : MIH_N2N_HO_Commit Indication Message
...
public class MihN2nHoCommitIndication extends Message implements
		Serializeable {

	public MihN2nHoCommitIndication() {
		super();
		mid = MIH_N2N_HO_Commit_indication;
	...
	public MihN2nHoCommitIndication(int version, boolean ack_req,
			boolean ack_rsp, boolean uir, boolean m, int fn, boolean rsvd1,
			int rsvd2, int tid) {
		super(version, ack_req, ack_rsp, uir, m, fn, rsvd1,
				MIH_N2N_HO_Commit_indication, rsvd2, tid);
		tlvList.add(new TlvInfo(new MobileNodeMihfIdTlv(), false));
		tlvList.add(new TlvInfo(new MnLinkIdTlv(), false));
		tlvList.add(new TlvInfo(new PoaTlv(), false));
		tlvList.add(new TlvInfo(new RequestResourceSetTlv(), false));
