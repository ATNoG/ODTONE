//==============================================================================
// Brief   : MIH_Get_Information Confirm Message
...
public class MihGetInformationConfirm extends Message implements
		Serializeable {

	public MihGetInformationConfirm() {
		super();
		mid = MIH_Get_Information_confirm;
	...
	public MihGetInformationConfirm(int version, boolean ack_req,
			boolean ack_rsp, boolean uir, boolean m, int fn, boolean rsvd1,
			int rsvd2, int tid) {
		super(version, ack_req, ack_rsp, uir, m, fn, rsvd1,
				MIH_Get_Information_confirm, rsvd2, tid);
		tlvList.add(new TlvInfo(new StatusTlv(), false));
		tlvList.add(new TlvInfo(new InfoResponseBinaryDataListTlv(), true));
		tlvList.add(new TlvInfo(new InfoResponseRdfDataListTlv(), true));
		tlvList.add(new TlvInfo(new InfoResponseRdfSchemaUrlListTlv(), true));
