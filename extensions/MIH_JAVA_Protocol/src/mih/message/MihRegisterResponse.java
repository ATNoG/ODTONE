//==============================================================================
// Brief   : MIH_Register Response Message
...
public class MihRegisterResponse extends Message implements
		Serializeable {

	public MihRegisterResponse() {
		super();
		mid = MIH_Register_response;
		tlvList.add(new TlvInfo(new StatusTlv(), false));
		tlvList.add(new TlvInfo(new ValidTimeIntervalTlv(), true));
	}

	public MihRegisterResponse(int version, boolean ack_req,
			boolean ack_rsp, boolean uir, boolean m, int fn, boolean rsvd1,
			int rsvd2, int tid) {
		super(version, ack_req, ack_rsp, uir, m, fn, rsvd1,
				MIH_Register_response, rsvd2, tid);
		tlvList.add(new TlvInfo(new StatusTlv(), false));
		tlvList.add(new TlvInfo(new ValidTimeIntervalTlv(), true));
	}
