//==============================================================================
// Brief   : MIH_MN_HO_Candidate_Query Response Message
...
public class MihMnHoCandidateQueryResponse extends Message implements
		Serializeable {

	public MihMnHoCandidateQueryResponse() {
		super();
		mid = MIH_MN_HO_Candidate_Query_response;
	...
	public MihMnHoCandidateQueryResponse(int version, boolean ack_req,
			boolean ack_rsp, boolean uir, boolean m, int fn, boolean rsvd1,
			int rsvd2, int tid) {
		super(version, ack_req, ack_rsp, uir, m, fn, rsvd1,
				MIH_MN_HO_Candidate_Query_response, rsvd2, tid);
		tlvList.add(new TlvInfo(new StatusTlv(), false));
		tlvList.add(new TlvInfo(new LinkIdentifierTlv(), false));
		tlvList.add(new TlvInfo(new PreferredLinkListTlv(), true));
	}
