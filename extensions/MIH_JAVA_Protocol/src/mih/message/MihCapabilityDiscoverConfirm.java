//==============================================================================
// Brief   : MIH_Capablity_Discover Confirm Message
...
public class MihCapabilityDiscoverConfirm extends Message implements
		Serializeable {

	public MihCapabilityDiscoverConfirm() {
		super();
		mid = MIH_Capability_Discover_confirm;
	...
	public MihCapabilityDiscoverConfirm(int version, boolean ack_req,
			boolean ack_rsp, boolean uir, boolean m, int fn, boolean rsvd1,
			int rsvd2, int tid) {
		super(version, ack_req, ack_rsp, uir, m, fn, rsvd1,
				MIH_Capability_Discover_confirm, rsvd2, tid);
		tlvList.add(new TlvInfo(new StatusTlv(), false));
		tlvList.add(new TlvInfo(new LinkAddressListTlv(), true));
		tlvList.add(new TlvInfo(new MihEventListTlv(), true));
		tlvList.add(new TlvInfo(new MihCommandListTlv(), true));
