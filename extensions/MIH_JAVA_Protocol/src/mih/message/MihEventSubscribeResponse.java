//==============================================================================
// Brief   : MIH_Event_Subscribe Response Message
...
public class MihEventSubscribeResponse extends Message implements
		Serializeable {

	public MihEventSubscribeResponse() {
		super();
		mid = MIH_Event_Subscribe_response;
	...
	public MihEventSubscribeResponse(int version, boolean ack_req,
			boolean ack_rsp, boolean uir, boolean m, int fn, boolean rsvd1,
			int rsvd2, int tid) {
		super(version, ack_req, ack_rsp, uir, m, fn, rsvd1,
				MIH_Event_Subscribe_response, rsvd2, tid);
		tlvList.add(new TlvInfo(new StatusTlv(), false));
		tlvList.add(new TlvInfo(new LinkIdentifierTlv(), false));
		tlvList.add(new TlvInfo(new MihEventListTlv(), true));
	}
