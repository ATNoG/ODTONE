//==============================================================================
// Brief   : MIH_Net_HO_Commit Request Message
...
public class MihNetHoCommitRequest extends Message implements
		Serializeable {

	public MihNetHoCommitRequest() {
		super();
		mid = MIH_Net_HO_Commit_request;
	...
	public MihNetHoCommitRequest(int version, boolean ack_req,
			boolean ack_rsp, boolean uir, boolean m, int fn, boolean rsvd1,
			int rsvd2, int tid) {
		super(version, ack_req, ack_rsp, uir, m, fn, rsvd1,
				MIH_Net_HO_Commit_request, rsvd2, tid);
		tlvList.add(new TlvInfo(new LinkTypeTlv(), false));
		tlvList.add(new TlvInfo(new ListOfTargetNetworkInfoTlv(), false));
		tlvList.add(new TlvInfo(new AssignedResourceSetTlv(), false));
		tlvList.add(new TlvInfo(new TimeIntervalTlv(), false));
