//==============================================================================
// Brief   : MIH_Event_Subscribe Request Message
...
public class MihEventSubscribeRequest extends Message implements
		Serializeable {

	public MihEventSubscribeRequest() {
		super();
		mid = MIH_Event_Subscribe_request;
	...
	public MihEventSubscribeRequest(int version, boolean ack_req,
			boolean ack_rsp, boolean uir, boolean m, int fn, boolean rsvd1,
			int rsvd2, int tid) {
		super(version, ack_req, ack_rsp, uir, m, fn, rsvd1,
				MIH_Event_Subscribe_request, rsvd2, tid);
		tlvList.add(new TlvInfo(new LinkIdentifierTlv(), false));
		tlvList.add(new TlvInfo(new MihEventListTlv(), false));
		tlvList.add(new TlvInfo(new EventConfigurationInfoListTlv(), true));
	}
