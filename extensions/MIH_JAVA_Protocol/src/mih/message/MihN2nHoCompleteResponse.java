//==============================================================================
// Brief   : MIH_N2N_HO_Complete Response Message
...
public class MihN2nHoCompleteResponse extends Message implements
		Serializeable {

	public MihN2nHoCompleteResponse() {
		super();
		mid = MIH_N2N_HO_Complete_response;
	...
	public MihN2nHoCompleteResponse(int version, boolean ack_req,
			boolean ack_rsp, boolean uir, boolean m, int fn, boolean rsvd1,
			int rsvd2, int tid) {
		super(version, ack_req, ack_rsp, uir, m, fn, rsvd1,
				MIH_N2N_HO_Complete_response, rsvd2, tid);
		tlvList.add(new TlvInfo(new StatusTlv(), false));
		tlvList.add(new TlvInfo(new MobileNodeMihfIdTlv(), false));
		tlvList.add(new TlvInfo(new LinkIdentifierTlv(), false));
		tlvList.add(new TlvInfo(new NewLinkIdentifierTlv(), false));
