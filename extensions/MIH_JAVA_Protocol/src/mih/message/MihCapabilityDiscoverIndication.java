//==============================================================================
// Brief   : MIH_Capablity_Discover Indication Message
...
public class MihCapabilityDiscoverIndication extends Message implements
		Serializeable {

	public MihCapabilityDiscoverIndication() {
		super();
		mid = MIH_Capability_Discover_indication;
	...
	public MihCapabilityDiscoverIndication(int version, boolean ack_req,
			boolean ack_rsp, boolean uir, boolean m, int fn, boolean rsvd1,
			int rsvd2, int tid) {
		super(version, ack_req, ack_rsp, uir, m, fn, rsvd1,
				MIH_Capability_Discover_indication, rsvd2, tid);
		tlvList.add(new TlvInfo(new LinkAddressListTlv(), true));
		tlvList.add(new TlvInfo(new MihEventListTlv(), true));
		tlvList.add(new TlvInfo(new MihCommandListTlv(), true));
		tlvList.add(new TlvInfo(new MiisQueryTypeListTlv(), true));
