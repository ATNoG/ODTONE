//==============================================================================
// Brief   : MIH_N2N_HO_Query_Resources Confirm Message
...
public class MihN2nHoQueryResourcesConfirm extends Message implements
		Serializeable {

	public MihN2nHoQueryResourcesConfirm() {
		super();
		mid = MIH_N2N_HO_Query_Resoures_confirm;
	...
	public MihN2nHoQueryResourcesConfirm(int version, boolean ack_req,
			boolean ack_rsp, boolean uir, boolean m, int fn, boolean rsvd1,
			int rsvd2, int tid) {
		super(version, ack_req, ack_rsp, uir, m, fn, rsvd1,
				MIH_N2N_HO_Query_Resoures_confirm, rsvd2, tid);
		tlvList.add(new TlvInfo(new StatusTlv(), false));
		tlvList.add(new TlvInfo(new ResourceStatusTlv(), true));
		tlvList.add(new TlvInfo(new PreferredLinkListTlv(), true));
	}
