//==============================================================================
// Brief   : CHOICE(NULL, NET_AUX_ID) Data Type
...
public class NullNetAuxIdChoice implements Serializeable {

	public NullNetAuxIdChoice(Null value) {
		selector = new UnsignedInteger8(0);
		object = value;
	}

	public NullNetAuxIdChoice(NetAuxId value) {
		selector = new UnsignedInteger8(1);
		object = value;
	}

	public NullNetAuxIdChoice(NullNetAuxIdChoice value) {
		selector = value.selector;
		object = value.object;
	}

	public NullNetAuxIdChoice() {
		selector = new UnsignedInteger8(0);
		object = new Object();
	}
	...
	public void toBytes(ByteArrayOutputStream stream) {
		...
		case 1:
			((NetAuxId)object).toBytes(stream);
			break;
		}
	}
	...
	public void fromBytes(ByteArrayInputStream stream) {
		...
		case 1:
			object = new NetAuxId();
			((NetAuxId)object).fromBytes(stream);
			break;
		}
	}
