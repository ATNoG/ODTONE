//==============================================================================
// Brief   : CHOICE(NULL, BOOLEAN, FN_AGNT) Data Type
...
import mih.types.handover.FnAgnt;

public class NullBooleanFnAgntChoice implements Serializeable {

	public NullBooleanFnAgntChoice(Null value) {
		selector = new UnsignedInteger8(0);
		object = value;
	}

	public NullBooleanFnAgntChoice(Boolean value) {
		selector = new UnsignedInteger8(1);
		object = value;
	}

	public NullBooleanFnAgntChoice(FnAgnt value) {
		selector = new UnsignedInteger8(2);
		object = value;
	}

	public NullBooleanFnAgntChoice(NullBooleanFnAgntChoice value) {
		selector = value.selector;
		object = value.object;
	}

	public NullBooleanFnAgntChoice() {
		selector = new UnsignedInteger8(0);
		object = new Object();
	}
	...
	public void fromBytes(ByteArrayInputStream stream) throws Exception {
		...
		case 2:
			object = new FnAgnt();
			((FnAgnt)object).fromBytes(stream);
			break;
		}
	}
