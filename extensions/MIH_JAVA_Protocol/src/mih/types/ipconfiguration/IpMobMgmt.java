...
public class IpMobMgmt extends Bitmap implements Serializeable {

	public enum IpMobMgmtEnum {
	...
	public IpMobMgmt(IpMobMgmt value) {
		super(value);
	}
