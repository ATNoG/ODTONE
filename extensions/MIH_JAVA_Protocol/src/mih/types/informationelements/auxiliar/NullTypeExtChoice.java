//==============================================================================
// Brief   : CHOICE(NULL, TYPE_EXT) Data Type
...
import mih.types.informationelements.TypeExt;

public class NullTypeExtChoice implements Serializeable {

	public NullTypeExtChoice(Null value) {
		selector = new UnsignedInteger8(0);
		object = value;
	}

	public NullTypeExtChoice(TypeExt value) {
		selector = new UnsignedInteger8(1);
		object = value;
	}

	public NullTypeExtChoice(NullTypeExtChoice value) {
		selector = value.selector;
		object = value.object;
	}

	public NullTypeExtChoice() {
		selector = new UnsignedInteger8(0);
		object = new Object();
	}
	...
	public void fromBytes(ByteArrayInputStream stream) throws Exception {
		...
		case 1:
			object = new TypeExt();
			((TypeExt)object).fromBytes(stream);
			break;
		}
	}
