//==============================================================================
// Brief   : CHOICE(NULL, FN_AGNT) Data Type
...
public class NullFnAgntChoice implements Serializeable {

	public NullFnAgntChoice(Null value) {
		selector = new UnsignedInteger8(0);
		object = value;
	}

	public NullFnAgntChoice(FnAgnt value) {
		selector = new UnsignedInteger8(1);
		object = value;
	}

	public NullFnAgntChoice(NullFnAgntChoice value) {
		selector = value.selector;
		object = value.object;
	}

	public NullFnAgntChoice() {
		selector = new UnsignedInteger8(0);
		object = new Object();
	}
