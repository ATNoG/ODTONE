//==============================================================================
// Brief   : CHOICE(NULL, SUBTYPE) Data Type
...
import mih.types.informationelements.Subtype;

public class NullSubtypeChoice implements Serializeable {

	public NullSubtypeChoice(Null value) {
		selector = new UnsignedInteger8(0);
		object = value;
	}

	public NullSubtypeChoice(Subtype value) {
		selector = new UnsignedInteger8(1);
		object = value;
	}

	public NullSubtypeChoice(NullSubtypeChoice value) {
		selector = value.selector;
		object = value.object;
	}

	public NullSubtypeChoice() {
		selector = new UnsignedInteger8(0);
		object = new Object();
	}
	...
	public void fromBytes(ByteArrayInputStream stream) throws Exception {
		...
		case 1:
			object = new Subtype();
			((Subtype)object).fromBytes(stream);
			break;
		}
	}
