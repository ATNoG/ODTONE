//==============================================================================
// Brief   : CHOICE(NULL, PARAMETERS) Data Type
...
import mih.types.informationelements.Parameters;

public class NullParametersChoice implements Serializeable {

	public NullParametersChoice(Null value) {
		selector = new UnsignedInteger8(0);
		object = value;
	}

	public NullParametersChoice(Parameters value) {
		selector = new UnsignedInteger8(1);
		object = value;
	}

	public NullParametersChoice(NullParametersChoice value) {
		selector = value.selector;
		object = value.object;
	}

	public NullParametersChoice() {
		selector = new UnsignedInteger8(0);
		object = new Object();
	}
	...
	public void toBytes(ByteArrayOutputStream stream) throws Exception {
		...
		case 1:
			((Parameters)object).toBytes(stream);
			break;
		}
	}
	...
	public void fromBytes(ByteArrayInputStream stream) throws Exception {
		...
		case 1:
			...
			((Parameters)object).fromBytes(stream);
			break;
		}
	}
