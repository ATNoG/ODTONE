//==============================================================================
// Brief   : CHOICE(NULL, THRESHOLD) Data Type
...
import mih.types.links.Threshold;

public class NullThresholdChoice implements Serializeable {

	public NullThresholdChoice(Null value) {
		selector = new UnsignedInteger8(0);
		object = value;
	}

	public NullThresholdChoice(Threshold value) {
		selector = new UnsignedInteger8(1);
		object = value;
	}

	public NullThresholdChoice(NullThresholdChoice value) {
		selector = value.selector;
		object = value.object;
	}

	public NullThresholdChoice() {
		selector = new UnsignedInteger8(0);
		object = new Object();
	}
	...
	public void toBytes(ByteArrayOutputStream stream) throws Exception {
		...
		case 1:
			((Threshold)object).toBytes(stream);
			break;
		}
	}
	...
	public void fromBytes(ByteArrayInputStream stream) throws Exception {
		...
		case 1:
			object = new Threshold();
			((Threshold)object).fromBytes(stream);
			break;
		}
	}
