//==============================================================================
// Brief   : CHOICE(NULL, LINK_ADDR) Data Type
...
public class NullLinkAddrChoice implements Serializeable {

	public NullLinkAddrChoice(Null value) {
		selector = new UnsignedInteger8(0);
		object = value;
	}

	public NullLinkAddrChoice(LinkAddr value) {
		selector = new UnsignedInteger8(1);
		object = value;
	}

	public NullLinkAddrChoice(NullLinkAddrChoice value) {
		selector = value.selector;
		object = value.object;
	}

	public NullLinkAddrChoice() {
		selector = new UnsignedInteger8(0);
		object = new Object();
	}
