//==============================================================================
// Brief   : CHOICE(NULL, TIMER_INTERVAL) Data Type
...
import mih.types.links.TimerInterval;

public class NullTimerIntervalChoice implements Serializeable {

	public NullTimerIntervalChoice(Null value) {
		selector = new UnsignedInteger8(0);
		object = value;
	}

	public NullTimerIntervalChoice(TimerInterval value) {
		selector = new UnsignedInteger8(1);
		object = value;
	}

	public NullTimerIntervalChoice(NullTimerIntervalChoice value) {
		selector = value.selector;
		object = value.object;
	}

	public NullTimerIntervalChoice() {
		selector = new UnsignedInteger8(0);
		object = new Object();
	}
	...
	public void toBytes(ByteArrayOutputStream stream) {
		...
		case 1:
			((TimerInterval)object).toBytes(stream);
			break;
		}
	}
	...
	public void fromBytes(ByteArrayInputStream stream) {
		...
		case 1:
			object = new TimerInterval();
			((TimerInterval)object).fromBytes(stream);
			break;
		}
	}
