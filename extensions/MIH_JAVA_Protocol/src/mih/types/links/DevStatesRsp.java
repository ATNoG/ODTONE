//==============================================================================
// Brief   : DEV_STATES_RSP Data Type
...
public class DevStatesRsp implements Serializeable {

	public DevStatesRsp(DeviceInfo value) {
		selector = new UnsignedInteger8(0);
		object = value;
	}

	public DevStatesRsp(BattLevel value) {
		selector = new UnsignedInteger8(1);
		object = value;
	}

	public DevStatesRsp(DevStatesRsp value) {
	...
	public void toBytes(ByteArrayOutputStream stream) {
		...
		case 0:
			((DeviceInfo)object).toBytes(stream);
			break;

		case 1:
			((BattLevel)object).toBytes(stream);
			break;
		}
	}
	...
	public void fromBytes(ByteArrayInputStream stream) {
		...
		case 0:
			...
			((DeviceInfo)object).fromBytes(stream);
			break;

		case 1:
			object = new BattLevel();
			((BattLevel)object).fromBytes(stream);
			break;
		}
	}
