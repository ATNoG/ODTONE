...
import mih.types.general.Percentage;

public class SigStrength implements Serializeable {

	public SigStrength(Integer8 value) {
		selector = new UnsignedInteger8(0);
		object = value;
	}

	public SigStrength(Percentage value) {
		selector = new UnsignedInteger8(1);
		object = value;
	}

	public SigStrength(SigStrength value) {
	...
	public void toBytes(ByteArrayOutputStream stream) {
		...
		case 0:
			((Integer8)object).toBytes(stream);
			break;

		case 1:
			((Percentage)object).toBytes(stream);
			break;
		}
	}
	...
	public void fromBytes(ByteArrayInputStream stream) {
		...
		case 0:
			object = new Integer8();
			((Integer8)object).fromBytes(stream);
			break;

		case 1:
			object = new Percentage();
			((Percentage)object).fromBytes(stream);
			break;
		}
	}
