//==============================================================================
// Brief   : PK_DELAY_JITTER Data Type
...
public class PkDelayJitter
	...
	public PkDelayJitter(CosId cos, UnsignedInteger16 value) {
		super(cos, value);
	}

	public PkDelayJitter(PkDelayJitter value) {
		super(value.getCosId(), value.getValue());
	}

	public PkDelayJitter() {
