//==============================================================================
// Brief   : CHOICE(NULL, RPT_TEMPL) Data Type
...
import mih.types.informationservicequery.RptTempl;

public class NullRptTemplChoice implements Serializeable {

	public NullRptTemplChoice(Null value) {
		selector = new UnsignedInteger8(0);
		object = value;
	}

	public NullRptTemplChoice(RptTempl value) {
		selector = new UnsignedInteger8(1);
		object = value;
	}

	public NullRptTemplChoice(NullRptTemplChoice value) {
		selector = value.selector;
		object = value.object;
	}

	public NullRptTemplChoice() {
		selector = new UnsignedInteger8(0);
		object = new Object();
	}
	...
	public void toBytes(ByteArrayOutputStream stream) throws Exception {
		...
		case 1:
			((RptTempl)object).toBytes(stream);
			break;
		}
	}
	...
	public void fromBytes(ByteArrayInputStream stream) throws Exception {
		...
		case 1:
			object = new RptTempl();
			((RptTempl)object).fromBytes(stream);
			break;
		}
	}
