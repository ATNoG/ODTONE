//==============================================================================
// Brief   : CHOICE(NULL, NGHB_RADIUS) Data Type
...
import mih.types.informationservicequery.NghbRadius;

public class NullNghbRadiusChoice implements Serializeable {

	public NullNghbRadiusChoice(Null value) {
		selector = new UnsignedInteger8(0);
		object = value;
	}

	public NullNghbRadiusChoice(NghbRadius value) {
		selector = new UnsignedInteger8(1);
		object = value;
	}

	public NullNghbRadiusChoice(NullNghbRadiusChoice value) {
		selector = value.selector;
		object = value.object;
	}

	public NullNghbRadiusChoice() {
		selector = new UnsignedInteger8(0);
		object = new Object();
	}
	...
	public void toBytes(ByteArrayOutputStream stream) throws Exception {
		...
		case 1:
			((NghbRadius)object).toBytes(stream);
			break;
		}
	}
	...
	public void fromBytes(ByteArrayInputStream stream) throws Exception {
		...
		case 1:
			object = new NghbRadius();
			((NghbRadius)object).fromBytes(stream);
			break;
		}
	}
