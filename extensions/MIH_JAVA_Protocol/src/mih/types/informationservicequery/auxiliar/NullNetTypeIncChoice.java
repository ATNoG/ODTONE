//==============================================================================
// Brief   : CHOICE(NULL, NET_TYPE_INC) Data Type
...
import mih.types.informationservicequery.NetTypeInc;

public class NullNetTypeIncChoice implements Serializeable {

	public NullNetTypeIncChoice(Null value) {
		selector = new UnsignedInteger8(0);
		object = value;
	}

	public NullNetTypeIncChoice(NetTypeInc value) {
		selector = new UnsignedInteger8(1);
		object = value;
	}

	public NullNetTypeIncChoice(NullNetTypeIncChoice value) {
		selector = value.selector;
		object = value.object;
	}

	public NullNetTypeIncChoice() {
		selector = new UnsignedInteger8(0);
		object = new Object();
	}
	...
	public void toBytes(ByteArrayOutputStream stream) throws Exception {
		...
		case 1:
			((NetTypeInc)object).toBytes(stream);
			break;
		}
	}
	...
	public void fromBytes(ByteArrayInputStream stream) throws Exception {
		...
		case 1:
			object = new NetTypeInc();
			((NetTypeInc)object).fromBytes(stream);
			break;
		}
	}
