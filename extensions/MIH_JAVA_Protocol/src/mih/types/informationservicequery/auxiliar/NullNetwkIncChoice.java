//==============================================================================
// Brief   : CHOICE(NULL, NETWK_INC) Data Type
...
import mih.types.informationservicequery.NetwkInc;

public class NullNetwkIncChoice implements Serializeable {

	public NullNetwkIncChoice(Null value) {
		selector = new UnsignedInteger8(0);
		object = value;
	}

	public NullNetwkIncChoice(NetwkInc value) {
		selector = new UnsignedInteger8(1);
		object = value;
	}

	public NullNetwkIncChoice(NullNetwkIncChoice value) {
		selector = value.selector;
		object = value.object;
	}

	public NullNetwkIncChoice() {
		selector = new UnsignedInteger8(0);
		object = new Object();
	}
	...
	public void toBytes(ByteArrayOutputStream stream) throws Exception {
		...
		case 1:
			((NetwkInc)object).toBytes(stream);
			break;
		}
	}
	...
	public void fromBytes(ByteArrayInputStream stream) throws Exception {
		...
		case 1:
			object = new NetwkInc();
			((NetwkInc)object).fromBytes(stream);
			break;
		}
	}
