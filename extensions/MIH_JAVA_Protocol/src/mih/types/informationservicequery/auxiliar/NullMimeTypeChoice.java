//==============================================================================
// Brief   : CHOICE(NULL, MIME_TYPE) Data Type
...
import mih.types.informationservicequery.MimeType;

public class NullMimeTypeChoice implements Serializeable {

	public NullMimeTypeChoice(Null value) {
		selector = new UnsignedInteger8(0);
		object = value;
	}

	public NullMimeTypeChoice(MimeType value) {
		selector = new UnsignedInteger8(1);
		object = value;
	}

	public NullMimeTypeChoice(NullMimeTypeChoice value) {
		selector = value.selector;
		object = value.object;
	}

	public NullMimeTypeChoice() {
		selector = new UnsignedInteger8(0);
		object = new Object();
	}
	...
	public void toBytes(ByteArrayOutputStream stream) throws Exception {
		...
		case 1:
			((MimeType)object).toBytes(stream);
			break;
		}
	}
	...
	public void fromBytes(ByteArrayInputStream stream) throws Exception {
		...
		case 1:
			object = new MimeType();
			((MimeType)object).fromBytes(stream);
			break;
		}
	}
