//==============================================================================
// Brief   : CHOICE(NULL, NETWORK_ID) Data Type
...
public class NullNetworkIdChoice implements Serializeable {

	public NullNetworkIdChoice(Null value) {
		selector = new UnsignedInteger8(0);
		object = value;
	}

	public NullNetworkIdChoice(NetworkId value) {
		selector = new UnsignedInteger8(1);
		object = value;
	}

	public NullNetworkIdChoice(NullNetworkIdChoice value) {
		selector = value.selector;
		object = value.object;
	}

	public NullNetworkIdChoice() {
		selector = new UnsignedInteger8(0);
		object = new Object();
	}
	...
	public void toBytes(ByteArrayOutputStream stream) {
		...
		case 1:
			((NetworkId)object).toBytes(stream);
			break;
		}
	}
	...
	public void fromBytes(ByteArrayInputStream stream) {
		...
		case 1:
			object = new NetworkId();
			((NetworkId)object).fromBytes(stream);
			break;
		}
	}
