...
public class MIH_Protocol_Header {
    ...
    public void TransactionID(int value) {
        ...
        UInt16 _trans = new UInt16(value);
        byte[] bs     = _trans.getValue();
        byte[] ba     = new byte[2];

        ba[0] = (byte) (ba[0] | (bs[0] & 0x0F));
        ba[1] = (byte) (ba[0] | (bs[1] & 0xFF));
        TransactionID.setValue(ba);
    }
    ...
    public class AID {
         ...
         *
         */
        public static final int MIH_SENSOR_ACTION               = 12;
        /**
         *
         */
        public static final int MIH_SENSOR_CONFIGURE_THRESHOLDS = 13;
        /**
         *
         */
        public static final int MIH_SENSOR_Capability_Discover  = 8;
        /**
         *
         */
        public static final int MIH_SENSOR_EVENT                = 10;
        /**
         *
         */
        public static final int MIH_SENSOR_Event_Subscribe      = 6;
        /**
         *
         */
        public static final int MIH_SENSOR_Event_UnSubscribe    = 7;
        /**
         *
         */
        public static final int MIH_SENSOR_PARAM_REPORT         = 9;
    }
